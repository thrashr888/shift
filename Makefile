...
test: build
	@set -e; for suite in sha256 changes patch coding default-agent json provider tools extensions runtime session trace prompt compaction recovery context daily; do \
